 ...
 * ****************************************************************************
 */
public class FriendsLazyListAdapter extends AbstractFriendsLazyListAdapter {

    public FriendsLazyListAdapter(Context context) {
        super(context);
    }

    @Override
    public View newView(Context context, FriendsLocalObject item, ViewGroup parent) {
        if (item == null) return null;
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        return inflater.inflate(R.layout.entry_friends_list, parent, false);
    }

    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    @Override
    public void bindView(View view, Context context, final FriendsLocalObject item) {
        TextView firstLineView =(TextView) view.findViewById(R.id.text_friend_gridview);
        ImageView imageItem =(ImageView) view.findViewById(R.id.icon_friend_gridview);
        ImageButton removeFriend =(ImageButton) view.findViewById(R.id.remove_friend);
        ...
        removeFriend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                INQ.friendsDelegator.removeFriend(INQ.accounts.getLoggedInAccount().getAccountType(),
                        INQ.accounts.getLoggedInAccount().getLocalId(),
                        item.getAccountLocalObject().getAccountType(),
                        item.getAccountLocalObject().getLocalId());
            }
        });
        ...
        if (item.getIcon() != null){
            ...
            imageItem.setImageBitmap(BitmapFactory.decodeResource(context.getResources(), R.drawable.ic_friend_default));
        }
    }
