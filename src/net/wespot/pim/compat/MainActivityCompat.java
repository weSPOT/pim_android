...
public class MainActivityCompat extends ActionBarCompat implements ListItemClickInterface<View> {
    ...
    private ActionBarGeneric mActionBarHelper;
    ...
    public void onListItemClick(View v, int id, View object) {
        switch (id){
            case Constants.ID_MYINQUIRIES:
                Intent intent_inquiries = new Intent(getApplicationContext(), PimInquiriesCompatFragment.class);
