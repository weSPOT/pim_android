 ...
 */
public class InqMyMediaCompatFragment extends ActionBarCompat implements ListItemClickInterface<GeneralItemLocalObject> {
    ...
    public void onListItemClick(View v, int position, GeneralItemLocalObject object) {
        Intent intent = new Intent(getApplicationContext(), InqMyMediaDataCollectionTaskCompatFragment.class);
